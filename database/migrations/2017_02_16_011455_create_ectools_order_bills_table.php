...
class CreateEctoolsOrderBillsTable extends Migration {
	...
	public function up()
	{
		Schema::create('ectools_order_bills', function(Blueprint $table)
		{
			$table->engin='InnoDB';
	...
	{
		Schema::drop('ectools_order_bills');
	}
